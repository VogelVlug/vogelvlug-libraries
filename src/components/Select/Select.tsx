...
interface SelectScrollButtonProps extends SelectPrimitive.SelectScrollUpButtonProps {
  className?: string;
}

const SelectScrollUpButton: React.FC<SelectScrollButtonProps> = ({ className, ...props }) => (
...
const SelectScrollDownButton: React.FC<SelectScrollButtonProps> = ({ className, ...props }) => (
...
const SelectContent: React.FC<SelectContentProps> = ({ className, children, position = "popper", ...props }) => (
...
const SelectSeparator: React.FC<SelectSeparatorProps> = ({ className, ...props }) => (
