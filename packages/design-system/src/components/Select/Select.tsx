...
const SelectScrollDownButton: React.FC<SelectScrollButtonProps> = ({
  className,
  ...props
}) => (
...
const SelectItem: React.FC<SelectItemProps> = ({
  ...
  <SelectPrimitive.Item
    className={cn(
      "relative flex w-full cursor-default select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm outline-hidden focus:bg-accent focus:text-accent-foreground data-disabled:pointer-events-none data-disabled:opacity-50 dark:focus:bg-neutral-500",
      className,
    )}
    {...props}
  >
